          ...
          <div className="space-y-10 text-center lg:text-left">
            ...
            <div className="flex flex-col  sm:flex-row gap-4 pt-4 ">
              ...
              <Button
                ...
                size="lg"
                onClick={handleBookPilot}
                className="border-2 border-[#1E4DFF]/30 text-[#444444]  hover:border-[#1E4DFF] font-bold px-10 py-4 text-lg rounded-xl shadow-sm hover:shadow-md transition-all duration-300"
              >
                Book a Pilot Program
              </Button>
            </div>
